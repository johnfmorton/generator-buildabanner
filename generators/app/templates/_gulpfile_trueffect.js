...
gulp.task('indexRenameForTruEffect', function() {
    return gulp.src('dist/index.html')
        .pipe(rename('frame.html'))
        .pipe(gulp.dest('dist'))
});

gulp.task('backupCopyForTruEffect', function() {
...
gulp.task('build', function(callback) {
    runSequence('del', 'copy-to-dist-folder', ['minify-html'], ['minify-inline', 'sass:dist'], 'uglify:dist', 'indexRenameForTruEffect', ['delForTruEffectCleanup'], ['backupCopyForTruEffect'], ['compress'],
        callback);
});
